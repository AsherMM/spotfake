        ...
        <div className="grid w-full gap-10 lg:grid-cols-2 lg:items-center">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-zinc-300">
              Sign in with your email and password, or continue instantly with
              Google or Discord to get back into Spotfake.
            </p>
          </div>
          ...
          <div className="w-full max-w-xl rounded-[2rem] border border-white/10 bg-zinc-900/80 p-6 shadow-2xl shadow-black/50 backdrop-blur-xl sm:p-8">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                Email login or continue with Google / Discord.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              >
                <DiscordIcon />
                {oauthLoading === "discord" ? "Redirecting..." : "Discord"}
              </button>
            </div>
